...
window.onload=function(){	
    ...
    /*
    makeRequest(cllGlobals.currentProtocalDomain+'/wp-content/plugins/ccll-cll_reactified/includes/server-sent-events/sse-demo.php', "POST", JSON.stringify({"empty": "obj"}))
    ...
    const socket = new WebSocket(`${time_sse_path}`);
    //console.log(socket);

    var source = new EventSource(`${time_sse_path}`);
    //console.log(`${time_sse_path}`);
    //console.log(source);
