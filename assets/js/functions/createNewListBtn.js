module.exports = function createNewListBtn(makeRequest){
	...
	*/
	...
	controlBox.appendChild(newListBtn);
		...
		if (confirm("Are you sure you would like to add a new list?")) {
			...
			makeRequest(cllGlobals.currentProtocalDomain+'/wp-json/wp/v2/cll-link/'+current_page_id, "POST")
				.then(function(request){
					...
					makeRequest(cllGlobals.currentProtocalDomain+'/wp-json/wp/v2/cll-link/'+current_page_id, "POST", JSON.stringify(NewShortCodeData), true)
						.then(function(){
