module.exports = function cllCreateForm(cllAddOnClickToSubmitBtn, cllAddOnClickToCancelBtn, isUrl, endLinkRequest, throughLinkRequest, makeRequest){
	var i = 0;
	...
	add_to_list_btn_array.forEach(function(add_to_list_btn){
		...
		add_to_list_btn.addEventListener("click", function(){//if button has not been clicked, create form
